...
* @Last Modified by:   xxi
* @Last Modified time: 2019-09-16 23:26:23
*/
...
$('.hot_list li').hover(function() {
	...
	$('.des_center').eq(i).css('display','block').siblings('.des_center').css('display','none')
});
...
$('.des_monthly li').hover(function() {
	...
	$('.month_img_ul').eq(i).css('display','block').siblings().css('display','none')
});
